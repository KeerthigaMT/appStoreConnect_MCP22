...
func Buildbetadetails_get_collectionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/v1/buildBetaDetails%s", cfg.BaseURL, queryString)
		...
		var result models.BuildBetaDetailsResponse
...
func CreateBuildbetadetails_get_collectionTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_v1_buildBetaDetails",
		mcp.WithDescription(""),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Buildbetadetails_get_collectionHandler(cfg),
	}
}
