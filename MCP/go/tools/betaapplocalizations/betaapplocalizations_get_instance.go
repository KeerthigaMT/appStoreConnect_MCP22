...
func Betaapplocalizations_get_instanceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/v1/betaAppLocalizations/%s%s", cfg.BaseURL, queryString)
...
func CreateBetaapplocalizations_get_instanceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_v1_betaAppLocalizations_id",
		mcp.WithDescription(""),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Betaapplocalizations_get_instanceHandler(cfg),
	}
}
