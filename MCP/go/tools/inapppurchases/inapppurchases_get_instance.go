...
func Inapppurchases_get_instanceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/v1/inAppPurchases/%s%s", cfg.BaseURL, queryString)
		...
		var result models.InAppPurchaseResponse
...
func CreateInapppurchases_get_instanceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_v1_inAppPurchases_id",
		mcp.WithDescription(""),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Inapppurchases_get_instanceHandler(cfg),
	}
}
