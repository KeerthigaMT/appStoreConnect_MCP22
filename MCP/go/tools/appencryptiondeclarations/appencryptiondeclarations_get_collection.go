...
func Appencryptiondeclarations_get_collectionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/v1/appEncryptionDeclarations%s", cfg.BaseURL, queryString)
		...
		var result models.AppEncryptionDeclarationsResponse
...
func CreateAppencryptiondeclarations_get_collectionTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_v1_appEncryptionDeclarations",
		mcp.WithDescription(""),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Appencryptiondeclarations_get_collectionHandler(cfg),
	}
}
