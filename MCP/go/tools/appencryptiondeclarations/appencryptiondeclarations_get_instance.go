...
func Appencryptiondeclarations_get_instanceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/v1/appEncryptionDeclarations/%s%s", cfg.BaseURL, queryString)
...
func CreateAppencryptiondeclarations_get_instanceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_v1_appEncryptionDeclarations_id",
		mcp.WithDescription(""),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Appencryptiondeclarations_get_instanceHandler(cfg),
	}
}
