...
func Appscreenshotsets_appscreenshots_get_to_many_relatedHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/v1/appScreenshotSets/%s/appScreenshots%s", cfg.BaseURL, queryString)
		...
		var result models.AppScreenshotsResponse
...
func CreateAppscreenshotsets_appscreenshots_get_to_many_relatedTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_v1_appScreenshotSets_id_appScreenshots",
		mcp.WithDescription(""),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Appscreenshotsets_appscreenshots_get_to_many_relatedHandler(cfg),
	}
}
