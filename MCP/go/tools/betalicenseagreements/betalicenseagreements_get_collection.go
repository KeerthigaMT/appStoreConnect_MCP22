...
func Betalicenseagreements_get_collectionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/v1/betaLicenseAgreements%s", cfg.BaseURL, queryString)
		...
		var result models.BetaLicenseAgreementsResponse
...
func CreateBetalicenseagreements_get_collectionTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_v1_betaLicenseAgreements",
		mcp.WithDescription(""),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Betalicenseagreements_get_collectionHandler(cfg),
	}
}
