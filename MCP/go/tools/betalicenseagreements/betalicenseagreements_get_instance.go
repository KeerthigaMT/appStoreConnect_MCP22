...
func Betalicenseagreements_get_instanceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/v1/betaLicenseAgreements/%s%s", cfg.BaseURL, queryString)
...
func CreateBetalicenseagreements_get_instanceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_v1_betaLicenseAgreements_id",
		mcp.WithDescription(""),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Betalicenseagreements_get_instanceHandler(cfg),
	}
}
