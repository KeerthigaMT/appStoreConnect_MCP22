...
func Apps_get_collectionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		if val, ok := args["filter[appStoreVersions.appStoreState]"]; ok {
			queryParams = append(queryParams, fmt.Sprintf("filter[appStoreVersions.appStoreState]=%v", val))
		}
		if val, ok := args["filter[appStoreVersions.platform]"]; ok {
			queryParams = append(queryParams, fmt.Sprintf("filter[appStoreVersions.platform]=%v", val))
		}
		if val, ok := args["filter[bundleId]"]; ok {
			queryParams = append(queryParams, fmt.Sprintf("filter[bundleId]=%v", val))
		}
		if val, ok := args["filter[name]"]; ok {
			queryParams = append(queryParams, fmt.Sprintf("filter[name]=%v", val))
		}
		if val, ok := args["filter[sku]"]; ok {
			queryParams = append(queryParams, fmt.Sprintf("filter[sku]=%v", val))
		}
		if val, ok := args["filter[appStoreVersions]"]; ok {
			queryParams = append(queryParams, fmt.Sprintf("filter[appStoreVersions]=%v", val))
		}
		if val, ok := args["filter[id]"]; ok {
			queryParams = append(queryParams, fmt.Sprintf("filter[id]=%v", val))
		}
		if val, ok := args["exists[gameCenterEnabledVersions]"]; ok {
			queryParams = append(queryParams, fmt.Sprintf("exists[gameCenterEnabledVersions]=%v", val))
		}
		...
		url := fmt.Sprintf("%s/v1/apps%s", cfg.BaseURL, queryString)
		...
		var result models.AppsResponse
...
func CreateApps_get_collectionTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_v1_apps",
		mcp.WithDescription(""),
		mcp.WithArray("filter[appStoreVersions.appStoreState]", mcp.Description("filter by attribute 'appStoreVersions.appStoreState'")),
		mcp.WithArray("filter[appStoreVersions.platform]", mcp.Description("filter by attribute 'appStoreVersions.platform'")),
		mcp.WithArray("filter[bundleId]", mcp.Description("filter by attribute 'bundleId'")),
		mcp.WithArray("filter[name]", mcp.Description("filter by attribute 'name'")),
		mcp.WithArray("filter[sku]", mcp.Description("filter by attribute 'sku'")),
		mcp.WithArray("filter[appStoreVersions]", mcp.Description("filter by id(s) of related 'appStoreVersions'")),
		mcp.WithArray("filter[id]", mcp.Description("filter by id(s)")),
		mcp.WithArray("exists[gameCenterEnabledVersions]", mcp.Description("filter by existence or non-existence of related 'gameCenterEnabledVersions'")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Apps_get_collectionHandler(cfg),
	}
}
