...
func Appinfos_appinfolocalizations_get_to_many_relatedHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/v1/appInfos/%s/appInfoLocalizations%s", cfg.BaseURL, queryString)
		...
		var result models.AppInfoLocalizationsResponse
...
func CreateAppinfos_appinfolocalizations_get_to_many_relatedTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_v1_appInfos_id_appInfoLocalizations",
		mcp.WithDescription(""),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Appinfos_appinfolocalizations_get_to_many_relatedHandler(cfg),
	}
}
