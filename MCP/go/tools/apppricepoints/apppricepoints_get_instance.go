...
func Apppricepoints_get_instanceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/v1/appPricePoints/%s%s", cfg.BaseURL, queryString)
		...
		var result models.AppPricePointResponse
...
func CreateApppricepoints_get_instanceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_v1_appPricePoints_id",
		mcp.WithDescription(""),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Apppricepoints_get_instanceHandler(cfg),
	}
}
